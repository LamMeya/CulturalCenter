...
async def admin_venues_page(request: Request):
    return templates.TemplateResponse(request, "admin/venues.html")
...
async def admin_time_slots_page(request: Request):
    return templates.TemplateResponse(request, "admin/time_slots.html")
...
async def admin_users_page(request: Request):
    return templates.TemplateResponse(request, "admin/admin_users.html")


@router.get("/app-users", response_class=HTMLResponse)
async def admin_app_users_page(request: Request):
    return templates.TemplateResponse(request, "admin/app_users.html")
